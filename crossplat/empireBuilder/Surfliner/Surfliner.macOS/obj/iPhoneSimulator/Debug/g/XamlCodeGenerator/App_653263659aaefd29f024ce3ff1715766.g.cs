...
namespace Surfliner
{
	...
	public partial class App : Windows.UI.Xaml.Application
	{
		private void InitializeComponent()
		{
			...
			.Apply((c0 => 
			{
				// Source /Users/adron/Codez/adrons-ecosystem/crossplat/empireBuilder/Surfliner/Surfliner.Shared/App.xaml (Line 1:2)
			...
			global::Surfliner.macOS.GlobalStaticResources.Initialize();
			global::Surfliner.macOS.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::Surfliner.macOS.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::Surfliner.macOS.Resource.Drawable);
			#endif
			// Source ../../../../../../Surfliner.Shared/App.xaml (Line 1:2)
		}
...
{
	static class App_653263659aaefd29f024ce3ff1715766XamlApplyExtensions
	{
	}
}
